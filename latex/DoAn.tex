...
\usepackage{xcolor} % Cần cho listings với màu sắc
\usepackage{listings}
\usepackage{float}
...
% Định nghĩa lại tên cho autoref bằng tiếng Việt
...
\graphicspath{{Hinhve/}{figures/}} % Thư mục chứa các hình ảnh
...
\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{CƠ SỞ LÝ THUYẾT CHO GỢI Ý PHIM}
\label{chapter:Methodology}
\subfile{Chuong/3_0_Co_so_ly_thuyet}
