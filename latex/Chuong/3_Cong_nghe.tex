...
Trong chương này, em sẽ giới thiệu các công nghệ và nền tảng đã sử dụng trong quá trình phát triển ứng dụng gợi ý phim tích hợp genAI. Những công nghệ này đóng vai trò quan trọng trong việc xây dựng, triển khai và tối ưu hóa hệ thống, đảm bảo tính khả thi và hiệu quả của giải pháp.
...
Việc sử dụng React cho phép em chia nhỏ giao diện thành các thành phần độc lập, giúp dễ dàng quản lý, bảo trì và tái sử dụng mã nguồn. Ngoài ra, cơ chế ràng buộc dữ liệu một chiều (one-way data binding) và hệ sinh thái phong phú của React giúp việc phát triển các tính năng như tìm kiếm, lọc phim và hiển thị danh sách phim trở nên linh hoạt và hiệu quả hơn.

\subsection{Tailwind CSS}
Tailwind CSS là một framework CSS theo hướng utility-first, cung cấp các lớp (classes) tiện ích cấp thấp để xây dựng giao diện trực tiếp trong mã nguồn mà không cần rời khỏi tệp HTML hoặc JSX. Khác với các framework truyền thống, Tailwind CSS không áp đặt các thành phần giao diện có sẵn, giúp em có toàn quyền kiểm soát thiết kế và tùy biến giao diện hệ thống một cách linh hoạt theo ý muốn.
