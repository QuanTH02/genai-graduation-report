...
Đối với phương án tải toàn bộ ảnh và trailer xuống, tôi đã loại bỏ ngay sau khi xác định số lượng bộ phim để demo ứng dụng. Với 5000 bộ phim thì sẽ có tổng cộng hơn 250000 ảnh và 5000 video demo, việc tải về sẽ làm cho máy tính trở nên nặng và không tối ưu. Do đó, tôi đã nghiên cứu và tìm ra giải pháp để hệ thống tự động cập nhật dữ liệu, đó chính là sử dụng GitHub Actions.
...
Bước đầu tiên, tôi tạo một file crawlJson.py với mục đích crawl toàn bộ dữ liệu mới từ trang IMDb và lưu vào file update.sql, sau khi có file update.sql thì chỉ cần cập nhật vào môi trường local là sẽ có dữ liệu mới ngay lập tức.

Để hệ thống có thể tự động cập nhật dữ liệu, các bước thực hiện như sau:
...
Từ hình ảnh \ref{fig:rcm_ct_kq_3}, có thể nhận định rằng bộ phim được hệ thống đề xuất có mức độ tương đồng cao nhất với bộ phim Meg 2: The Trench là bộ phim The Meg. Hai bộ phim này thể hiện sự tương đồng đáng kể về tên phim, mô tả, diễn viên và đạo diễn.
