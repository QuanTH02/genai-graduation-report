...
\begin{enumerate}
    \item Lấy được tất cả những dữ liệu cần thiết phục vụ cho việc xây dựng ứng dụng. Để làm được mục tiêu này, tôi đã tìm rất nhiều tài liệu riêng về chủ đề crawl để có thể nghiên cứu và áp dụng được hoàn toàn vào đồ án của bản thân.
    \item Hoàn thành chức năng chính của ứng dụng. Tôi đã thêm được rất nhiều chức năng mà bản thân đã nghĩ khó có thể làm, nhờ đó tôi có thể biết được nhiều công nghệ, kiến thức hay ho hơn để áp dụng vào những dự án trong tương lai.
...
\begin{enumerate}
    ...
    \item  Dữ liệu đảm bảo, nhất quán, đầy đủ. Tôi đã crawl được bộ dữ liệu hoàn chỉnh phục vụ cho mục đích xây dựng ứng dụng của bản thân.
    \item Xây dựng được 2 hệ thống gợi ý riêng biệt áp dụng vào trang home và trang detail.
    \item Cấu trúc mã nguồn của tôi cho phép mở rộng và có thể phát triển các tính năng nâng cao.
\end{enumerate}

\textbf{Bài học kinh nghiệm cho bản thân}
Trong quá trình thực hiện đồ án, tôi đã rút ra được rất nhiều bài học như:
\begin{enumerate}
