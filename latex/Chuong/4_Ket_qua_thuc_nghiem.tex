...
Dưới đây là một số hình ảnh minh họa cho các giao diện người dùng đối với những chức năng cốt lõi của phần mềm:

\textbf{Thiết kế màn hình đăng nhập}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Hinhve/web_login.png}
    \caption[Thiết kế màn hình \textit{đăng nhập}]{Thiết kế màn hình \textit{đăng nhập}}
    \label{fig:web_login}
\end{figure}

\textbf{Thiết kế màn hình đăng ký}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Hinhve/web_signup.png}
    \caption[Thiết kế màn hình \textit{đăng ký}]{Thiết kế màn hình \textit{đăng ký}}
    \label{fig:web_signup}
\end{figure}

\textbf{Thiết kế màn hình profile}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Hinhve/web_profile.png}
    \caption[Thiết kế màn hình \textit{profile}]{Thiết kế màn hình \textit{profile}}
    \label{fig:web_profile}
\end{figure}

\textbf{Thiết kế màn hình chính}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Hinhve/web_home.png}
    \caption[Thiết kế màn hình \textit{chính}]{Thiết kế màn hình \textit{chính}}
    \label{fig:web_home}
\end{figure}

\textbf{Thiết kế màn hình gợi ý phim ở trang chủ}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Hinhve/web_recommend.png}
    \caption[Thiết kế màn hình \textit{gợi ý phim ở trang chủ}]{Thiết kế màn hình \textit{gợi ý phim ở trang chủ}}
    \label{fig:web_recommend}
\end{figure}

\textbf{Thiết kế màn hình thông tin chi tiết}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Hinhve/web_detail.png}
    \caption[Thiết kế màn hình \textit{thông tin chi tiết 1}]{Thiết kế màn hình \textit{thông tin chi tiết 1}}
...
\begin{figure}[H]
    ...
    \caption[Thiết kế màn hình \textit{thông tin chi tiết 2}]{Thiết kế màn hình \textit{thông tin chi tiết 2}}
    \label{fig:web_detail1}
\end{figure}

\textbf{Thiết kế màn hình tổng hợp đạo diễn, diễn viên, ...}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Hinhve/web_cast_and_crew.png}
    \caption[Thiết kế màn hình \textit{tổng hợp đạo diễn, diễn viên, ...}]{Thiết kế màn hình \textit{tổng hợp đạo diễn, diễn viên, ...}}
    \label{fig:web_cast_and_crew}
\end{figure}

\textbf{Thiết kế màn hình review phim}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Hinhve/web_user_review.png}
    \caption[Thiết kế màn hình \textit{review phim}]{Thiết kế màn hình \textit{review phim}}
